 ...
 * **Main Class**
 * 
 * This class is the entry point for the program, providing a 
 ...
 */
 ...
 public class Main{
	 ...
	 */
	 ...
	 /**
	  * Directs the menu according to the user's choice.
 ...
 ////////////// ARRAY OPERATIONS /////////////////
	 ...
	 static boolean arraySizeCheck(String str) { 		// check if the size is a positive integer value
		...
		//checks whether the user has entered a number character 
		try { 
